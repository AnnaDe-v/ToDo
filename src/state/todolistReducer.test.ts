import {todolistReducer, changeTodolistTitleAC, changeTodolistFilterAC, addTodolistAC} from './todolistReducer';
import {v1} from 'uuid';
...
test('correct todolist should be added', () => {
    ...
    const endState = todolistReducer(startState, addTodolistAC(todolistId2, newTodolistTitle))
